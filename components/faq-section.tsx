...
const faqs = [
  {
    ...
    answer: "시스템 기획서, 콘텐츠 기획서, 레벨 디자인 문서, UI/UX 기획서 등 게임 기획과 관련된 모든 문서를 분석할 수 있습니다. PDF, Word, 이미지 파일 모두 지원합니다."
  },
  {
    question: "AI 분석은 어떻게 이루어지나요?",
    answer: "합격 포트폴리오 100개 이상을 학습한 AI가 문서를 즉시 분석합니다. 구조, 논리, 창의성, 실현성, 표현력 5개 영역을 레이더 차트로 보여주고, 종합 점수와 S~D 등급을 부여합니다. 각 영역별 강점과 개선점도 상세히 피드백합니다."
  },
  {
