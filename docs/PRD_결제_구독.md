...
| 1크레딧 | credit_1 | 2,900원 | 1회 | - |
| 5크레딧 | credit_5 | 7,900원 | 5회 | 크레딧당 1,580원 |
| 10크레딧 | credit_10 | 12,900원 | 10회 | 크레딧당 1,290원 |
...
| three_month | 39,000원 | 무제한 | 무제한 | Sonnet | 3개월 |

> 2026-05-06 변경: 모든 플랜이 Sonnet 단일 모델을 사용합니다. (Opus 제거 — 비용 폭증 방지)
### 2.3 게임캔버스 할인
- 대상: monthly 플랜만
- 할인가: 5,900원/월
- 검증: `GAMECANVAS_DISCOUNT_CODES` 환경변수의 코드와 비교
- 주문명: "아카이브 187 월 구독 (게임캔버스)"
