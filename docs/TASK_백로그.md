...
- [x] PDF 분석 max_tokens 8192→16384 증가 + stop_reason 체크 (`ed54f62`) — 일부 PDF만 파싱 실패하던 문제 해결
- [x] 벤치마크 데이터 truncation 150자 (`0a2402b`) — 프롬프트 크기 초과 문제 해결
